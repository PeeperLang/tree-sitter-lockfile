...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 3),
  [23] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 2),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 4),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 5),
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2), SHIFT_REPEAT(6),
  [48] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2),
  [50] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_object_repeat1, 2), SHIFT_REPEAT(22),
  ...
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 2),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 4),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pair, 3, .production_id = 1),
...
extern const TSLanguage *tree_sitter_lockfile(void) {
